<template>
  <div class="animation-router home-homepage public-phone dengni">
      ...
      <div style="position: absolute;" :style="{ left: left, top: top }">
        <PhoneBox id="phone" style="background-color: #fff">
          ...
          <template slot="content">
            <img src="../../../static/icon/nishouqian.png" alt="" style="width: 100%;">
            <div class="con-text">
              <p>待{{appendFormData.name}}确认收款</p>
              <p style="font-size: 46px;">￥{{appendFormData.money}}</p>
            </div>
            <p class="bottomer">转账时间：{{appendFormData.time}}</p>
          </template>
...
<style type="text/sass" lang="sass">
  ...
  .dengni .phone-box .phone-box-content
    top: 20px
    bottom: 58px

  .dengni .phone-box-footer
    height: 58px

<template>
  <div class="animation-router home-homepage public-phone dengniok">
      ...
      <div style="position: absolute;" :style="{ left: left, top: top }">
        <PhoneBox id="phone" style="background-color: #fff">
          ...
          <template slot="content">
            <img src="../../../static/icon/niyjingshouoqian.png" alt="" style="width: 100%;">
            <div class="con-text">
              <p>{{appendFormData.name}}已收钱</p>
...
<style type="text/sass" lang="sass">
  ...
  .dengniok .phone-box .phone-box-content
    top: 20px
    bottom: 58px

  .dengniok .phone-box-footer
    height: 58px

      ...
      <div style="position: absolute;" :style="{ left: left, top: top }">
        <PhoneBox id="phone" style="background-color: #fff">
          ...
          <template slot="app-header">
            <weixinChatHeaderMany :config="weixinConfig"></weixinChatHeaderMany>
          </template>
...
<script type="text/ecmascript-6">
  ...
  import weixinChatHeaderMany from '../../../components/weixinChatHeaderMany'
  ...
  export default{
    ...
    mounted() {
      var callBack = VueDB.getItemOnce('weixinchat-send').toJson();

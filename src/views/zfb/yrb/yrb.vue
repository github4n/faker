      ...
      <div style="position: absolute;" :style="{ left: left, top: top }">
        <PhoneBox id="phone" style="background-color: #fff">
          <template slot="header">
            <HeaderView ref="HeaderView" bgcolor="#FF532A"></HeaderView>
          </template>

          <template slot="content">
            <img src="../../../static/icon/zfb-yyb-bg.png" alt="" style="width: 100%">
            ...
            <div class="getbox"
                 style="
                    ...
                    text-align: center;
                ">
              <h2 style="font-weight: normal;">{{zfbConfig.yestoday || 0}}</h2>
              <p style="font-size: 14px; position: relative; top: -4px;">
                总金额 {{zfbConfig.allmoney || 0}} <span style="position: relative">元<img src="../../../static/icon/zfb-eye.png" style="
                                                                  position: absolute;
                                                                  width: 18px;
                                                                  right: -30px;
                                                                  top: 1px;
